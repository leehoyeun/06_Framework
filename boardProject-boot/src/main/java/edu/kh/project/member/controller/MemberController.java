...
public class MemberController {
	 ...
	 * @param model : 데이터 전달용 객체 (기본request scope)
	...
	public String login(Member inputMember,RedirectAttributes ra, Model model,
		...
		if(loginMember == null) {
			...
			// 2단계 : 클래스 상단에 @SessionAttributes() 어노테이션 작성하여
			...
			cookie.setMaxAge(0);//0 초  (클라이언트 쿠키 삭제)
	 ...
	 * @param SessionStatus : @SessionAttributes로 지정된 속성을 세션에서 저거 기능
	 * @return
	 */
	@GetMapping("logout")
	...
	@GetMapping("checkEmail")  // GET 방식 요청 /member/chechEmail
