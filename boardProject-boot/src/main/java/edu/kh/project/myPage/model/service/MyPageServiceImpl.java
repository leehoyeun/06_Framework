...
public class MyPageServiceImpl implements MypageService {
	...
	//파일 업로드 테스트(+DB)
	@Override
	public int filUpload2(MultipartFile uploadFile, int memberNo) throws Exception {
...
//		}
	...
	@Override
	@Transactional(rollbackFor = Exception.class)
	public int deleteProfileImage(Member loginMember) {
		
		String fileName = loginMember.getProfileImg();
		
		if(fileName !=null) {
			//파일 삭제
			File file = new File("C:/uploadFiles/test/"+fileName);
