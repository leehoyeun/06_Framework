 ...
 * 
 * -poshHandle(후처리) : Controller -> DispatcherServlet 사이 수행
 * 
 * -afterCompletion (뷰 완성(forward 코드 해석)후):View Resolver 가 응답에 맞춰 DispatcherServlet 에 돌려줄 때 (6번에서 위로 갈 때)
 * */
@Slf4j
public class BoardTypeInterceptor implements HandlerInterceptor {
	...
	// (--> 응답을 가지고 DispatcherServlet에게 돌려보ㄴ기 전 수행)
	@Override
