...
@RequestMapping("param") // /param으로 시작하는 요청을 현재 컨드롤러로 매핑
...
public class ParameterController {
	...
	public String paramMain() {
		...
		//src/main/resources/templates/param/parram-main.html
	...
	//@ModelAttribute 를 이용해 값이 필드에 셋팅된 객체를
	// "커맨드 객체"라고 부른다.
	
	//@ModelAttribute
	
	@PostMapping("test4")
	public String paramTest4(/*@ModelAttribute (생략가능)*/ MemberDTO inputMember) {
